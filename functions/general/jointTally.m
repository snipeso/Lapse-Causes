...
% [Tally1, ~] = assemble_matrix_from_table(Trials, TrialSubset & TrialIndexes1, 'Type', 'tabulate', ...
%     Participants, Sessions, SessionGroups, CheckEyes); % P x SB x TT
% [Tally2, ~] = assemble_matrix_from_table(Trials, TrialSubset & TrialIndexes2, 'Type', 'tabulate', ...
%     Participants, Sessions, SessionGroups, CheckEyes);
%
% [Tally12, ~] = assemble_matrix_from_table(Trials, TrialIndexes1 & TrialIndexes2, 'Type', 'tabulate', ...
%     Participants, Sessions, SessionGroups, CheckEyes);
